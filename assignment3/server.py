...
def handle_req(url, body=None):
    ...
    # opening some files in binary mode, i.e. `open(..., "br")`.
        ...
        return open("./static/img/Goldy.png", "rb").read(), "image/png"
    elif url == "/img/direction.png":
        return open("./static/img/direction.png", "rb").read(), "image/png"
    elif url == "/img/search.png":
        return open("./static/img/search.png", "rb").read(), "image/png"
